...
if ($isWeb) {
    $output .= '<html>';
    $output .= '<head>';
    $output .= '<title>phpxlsx checker</title>';
    ...
    $output .= '<span>Welcome to php<span class="color">xlsx</span> checker</span>';
    $output .= '</div>';
    $output .= '</div>';
...
if (file_exists('config/phpxlsxconfig.ini')) {
	$output .= 'Config file: ' . "\n" . file_get_contents('config/phpxlsxconfig.ini');
}
