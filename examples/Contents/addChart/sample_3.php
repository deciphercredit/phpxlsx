<?php
// add column charts in an XLSX created from scratch
...
$content = array(
    'text' => 'A 2D col chart with table data:',
    'bold' => true,
);
...
$xlsx->addChart('col', 'H7', $optionsChart);

$content = array(
    'text' => 'A 3D col chart with a custom size:',
    'bold' => true,
);
...
$xlsx->addChart('col3D', 'H28', $optionsChart);

$xlsx->saveXlsx('example_addChart_3');