<?php
// change tabSelected and activeCell options in an existing XLSX
...
// set the third sheet as the active tab in the workbook
$xlsx->setWorkbookSettings(array('activeTab' => 2));

$xlsx->saveXlsx('example_setWorkbookSettings_2');