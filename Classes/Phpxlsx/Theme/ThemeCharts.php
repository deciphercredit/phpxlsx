...
class ThemeCharts
{
    ...
    public function theme($chartContent, $theme)
    {
        ...
        $this->chartDom = $xmlUtilities->generateDomDocument($chartContent);
    ...
    private function themeMajorGridlines($chartContent, $theme, $query)
    {
        ...
        $xmlGridLines = '<a:ln algn="ctr" cap="'.$styleCap.'" cmpd="dbl" w="'.$styleWidth.'" xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"><a:solidFill><a:srgbClr val="'.$styleColor.'"/></a:solidFill>';
        if ($styleDash != null) {
            $xmlGridLines .= '<a:prstDash val="'.$styleDash.'"/>';
        }
        $xmlGridLines .= '</a:ln><a:effectLst xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"/>';
    ...
    private function themeTextAxis($chartContent, $theme, $query)
    {
        ...
        if ($chartNodesAx->length > 0) {
            ...
            $tempNode->appendXML('<a:lstStyle xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"/><a:p xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"><a:pPr><a:defRPr b="'.$styleBold.'" baseline="0" i="'.$styleItalic.'" kern="1200" strike="noStrike" sz="'.$styleSize.'" u="'.$styleUnderline.'"><a:ln><a:noFill/></a:ln><a:solidFill><a:schemeClr val="tx1"><a:lumMod val="65000"/><a:lumOff val="35000"/></a:schemeClr></a:solidFill><a:latin typeface="+mn-lt"/><a:ea typeface="+mn-ea"/><a:cs typeface="+mn-cs"/></a:defRPr></a:pPr></a:p>');
